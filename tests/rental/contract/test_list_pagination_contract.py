...
class TestListPaginationContract(ContractApiTestCase):
    def setUp(self):
        super().setUp()
        ...
        self.total_count = len(self.list_contract)
        self.maxDiff = None

    def call_list_contract(
        self,
        len_list: int,
        expected_next: bool,
        ...
        self.validate_data_in_list_pagination(
            ...
            schema_validator=self.validate_contract_in_list,
        )
        return response_dict

    def call_multiples_list(self):
        self.call_list_contract(
            len_list=15,
            expected_next=True,
    ...
    def test_list_pagination_contract(self):
