...
class VehicleUpdateSerializer(serializers.Serializer):
    ...
    type = serializers.ChoiceField(
        required=False, choices=Vehicle.TYPE_CHOICES, allow_blank=False, allow_null=True
    )
    year = serializers.IntegerField(
        required=False,
    )
    make = serializers.CharField(required=False, allow_blank=False, allow_null=True)
    model = serializers.CharField(required=False, allow_blank=False, allow_null=True)
    trim = serializers.CharField(required=False, allow_blank=False, allow_null=True)
    vin = serializers.CharField(
        required=False, max_length=17, allow_blank=False, allow_null=True
    )
