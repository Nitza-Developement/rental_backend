...
from rental.models import User, Tenant, TenantUser, Client, Vehicle, VehiclePicture, Contract, Note, StageUpdate, TollDue, Tracker, TrackerHeartBeatData, RentalPlan
from rental.adminInline import ContractInline, TenantUserInline, ClientInline, VehicleInline, VehiclePlateInline, VehiclePictureInline, TrackerHeartbeatDataInline, NoteInline, TollDueInline, StageUpdateInline
...
class ContractAdmin(admin.ModelAdmin):
    list_display = ('id', 'tenant', 'client', 'vehicle', 'rental_plan', 'creation_date', 'active_date', 'end_date')
...
class TollDueAdmin(admin.ModelAdmin):
    list_display = ('id', 'plate', 'contract', 'stage', 'invoice', 'invoiceNumber', 'createDate', 'note')
    list_filter = ('stage',)
    search_fields = ('plate__plate', 'contract__tenant__name', 'contract__client__name', 'invoice', 'invoiceNumber')
